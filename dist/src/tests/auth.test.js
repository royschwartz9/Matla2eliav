...
describe("Auth Tests", () => {
    ...
    test("Test logout fail", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app).post(baseUrl + "/logout").send({
            refreshToken: testUser.refreshToken,
        });
        expect(response.statusCode).not.toBe(200);
    }));
    test("test tokan fail", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app).post("/posts").set({ authorization: "JWT " + testUser.accessToken + "sdf" }).send({
            title: "Test Post",
            content: "Test Content",
            Sender: "sdfSd",
        });
